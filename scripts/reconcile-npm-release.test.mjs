...
const spec = "@kyan-du/agent-wechat-cli@1.2.3-next.4";
test("existing package query is classified as existing", () => assert.equal(classifyNpmView({ status: 0, stdout: JSON.stringify({ version: "1.2.3-next.4", "dist.integrity": "sha512-ok" }), stderr: "" }, spec).kind, "exists"));
