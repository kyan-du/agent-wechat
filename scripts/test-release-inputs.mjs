...
const mutations=[
 ...
 d=>replace(d,'docker/Dockerfile','cp /opt/novnc/LICENSE.txt /opt/novnc/docs/LICENSE.* /usr/share/doc/agent-wechat/licenses/novnc/','cp /opt/novnc/LICENSE.txt /tmp/ && echo cp /opt/novnc/LICENSE.txt /opt/novnc/docs/LICENSE.* /usr/share/doc/agent-wechat/licenses/novnc/'),
 d=>replace(d,'docker/Dockerfile','cp LICENSE.md /usr/share/doc/agent-wechat/licenses/sqlcipher/','cp LICENSE.md /tmp/ && echo cp LICENSE.md /usr/share/doc/agent-wechat/licenses/sqlcipher/'),
