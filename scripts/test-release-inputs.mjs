...
const mutations=[
 ...
 d=>replace(d,'docker/Dockerfile','RUN WECHAT_VERSION=4.1.13.23','ARG WECHAT_VERSION=4.1.13.23\nRUN WECHAT_VERSION=4.1.13.23'),
 d=>replace(d,'docker/Dockerfile','RUN WECHAT_VERSION=4.1.13.23','ARG WECHAT_AMD64_URL\nRUN WECHAT_VERSION=4.1.13.23'),
 d=>replace(d,'docker/Dockerfile','RUN WECHAT_VERSION=4.1.13.23','RUN WECHAT_VERSION=4.1.13.24'),
 d=>replace(d,'docker/Dockerfile','WECHAT_ARM64_SHA256=51784a262c725ef1595dd833f456190e913583dd81c24dd8fe587532bc91c0dc','WECHAT_ARM64_SHA256=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'),
 d=>replace(d,'docker/Dockerfile','--max-redirs 0','--location --max-redirs 5'),
 d=>replace(d,'docker/Dockerfile','test "$http_code" = 200','echo http_code "$http_code"'),
 d=>replace(d,'docker/release-inputs.json','https://web.archive.org/web/20260923032446if_/https://dldir1v6.qq.com/weixin/Universal/Linux/WeChatLinux_arm64.deb','https://web.archive.org/web/20260921152526if_/https://dldir1v6.qq.com/weixin/Universal/Linux/WeChatLinux_arm64.deb'),
 d=>replace(d,'docker/release-inputs.json','https://web.archive.org/web/20260921152423if_/https://dldir1v6.qq.com/weixin/Universal/Linux/WeChatLinux_x86_64.deb','https://dldir1v6.qq.com/weixin/Universal/Linux/WeChatLinux_x86_64.deb'),
